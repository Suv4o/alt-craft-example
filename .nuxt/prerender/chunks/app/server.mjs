import { version, unref, inject, defineComponent, h, computed, ref, provide, shallowReactive, Suspense, nextTick, Transition, hasInjectionContext, getCurrentInstance, mergeProps, useSSRContext, createApp, effectScope, reactive, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, withCtx } from 'file:///Users/Suv4o/Development/Experiments/nuxt-test-1/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/Suv4o/Development/Experiments/nuxt-test-1/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/Suv4o/Development/Experiments/nuxt-test-1/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///Users/Suv4o/Development/Experiments/nuxt-test-1/node_modules/unctx/dist/index.mjs';
import { getActiveHead } from 'file:///Users/Suv4o/Development/Experiments/nuxt-test-1/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/Suv4o/Development/Experiments/nuxt-test-1/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/Suv4o/Development/Experiments/nuxt-test-1/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///Users/Suv4o/Development/Experiments/nuxt-test-1/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL } from 'file:///Users/Suv4o/Development/Experiments/nuxt-test-1/node_modules/ufo/dist/index.mjs';
import { defu } from 'file:///Users/Suv4o/Development/Experiments/nuxt-test-1/node_modules/defu/dist/defu.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/Suv4o/Development/Experiments/nuxt-test-1/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-3caa7381.mjs').then((m) => m.default || m)
  },
  {
    name: "page-2",
    path: "/page-2",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/page-2-69b6cb6d.mjs').then((m) => m.default || m)
  },
  {
    name: "page-3",
    path: "/page-3",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/page-3-bf73a811.mjs').then((m) => m.default || m)
  },
  {
    name: "page-4",
    path: "/page-4",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/page-4-9cf3aba3.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-e0868d80.mjs').then((m) => m.default || m)
};
